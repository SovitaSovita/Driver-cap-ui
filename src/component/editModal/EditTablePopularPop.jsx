...
import { popularSchema } from '../../utils/Validation';
...
function EditTablePopularPop(props) {
    ...
    const onSubmitHandle = (values) => {
        setIsLoading(true)
        update_popular(values, fileImg.imageFile, oldData.id).then((res) => {
            if (res?.status == 200) {
...
export default EditTablePopularPop